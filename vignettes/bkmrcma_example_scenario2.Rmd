---
title: "BKMR CMA Example 2"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{bkmrcma_example_scenario2}
...
```{r dpi = 300, fig.width=4, out.width = "80%"}
TE.ey10$est
TE.ey90$est
...
```{r warning=FALSE,dpi = 300, fig.width=4, out.width = "80%"} 
...
```{r dpi=300, fig.width=6, out.width = "80%"}
...
```{r TERisk, warning=FALSE,dpi = 300, out.width = "80%"}
...
### Total Effect
```{r warning=FALSE, message=FALSE, dpi=300, out.width = "80%"}
...
```{r CDERisksingvar10, warning=FALSE, message=FALSE, results='hide', dpi = 300, out.width = "80%"} 
...
```{r CDERisksingvar90, warning=FALSE, message=FALSE, results='hide', dpi = 300, out.width = "80%"} 
