...
```{r warning=FALSE,dpi = 300, fig.width=4} 
...
```{r TERisk, warning=FALSE,dpi = 300}
...
```{r CDERisksingvar10, warning=FALSE, message=FALSE, results='hide', dpi = 300} 
...
```{r CDERisksingvar90, warning=FALSE, message=FALSE, results='hide', dpi = 300} 
