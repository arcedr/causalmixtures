...
```{r warning=FALSE, dpi = 300, out.width = "60%"} 
...
```{r TERisk, warning=FALSE, dpi = 300, out.width = "60%"}
...
### Total Effect
```{r warning=FALSE, message=FALSE, dpi = 300, out.width = "70%"}
...
```{r CDERisksingvar10, warning=FALSE, message=FALSE, results='hide', dpi = 300, out.width = "70%"} 
