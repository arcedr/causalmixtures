...
```{r CDERisk, warning=FALSE, message=FALSE, results='hide', fig.dim=c(8, 6), out.width = "80%"} 
# CDE 
...
### Total Effect
```{r TEsingvar, warning=FALSE, message=FALSE, results='hide', fig.dim=c(6, 4), out.width = "80%"}
...
```{r CDERisksingvar10, warning=FALSE, message=FALSE, results='hide', fig.dim=c(6, 4), out.width = "80%"} 
